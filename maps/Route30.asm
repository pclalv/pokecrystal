...
Route30_MapEvents:
	...
	db 11 ; object events
.ckir_BEFORE_OBJECT_EVENT_YOUNGSTER_EVENT_ROUTE_30_BATTLE::
	;; make it so that the player can progress without returning
	;; the MYSTERY EGG to Elm by replacing EVENT_ROUTE_30_BATTLE with
	;; EVENT_GOT_A_POKEMON_FROM_ELM
	object_event  5, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, YoungsterJoey_ImportantBattleScript, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_OBJECT_EVENT_YOUNGSTER_EVENT_ROUTE_30_BATTLE::
.ckir_BEFORE_EVENT_ROUTE_30_YOUNGSTER_JOEY::
	;; make the battleable Youngster Joey appear
	object_event  2, 28, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerYoungsterJoey, EVENT_PLAYERS_HOUSE_MOM_2
.ckir_AFTER_EVENT_ROUTE_30_YOUNGSTER_JOEY::
...
.ckir_BEFORE_OBJECT_EVENT_MONSTER_EVENT_ROUTE_30_BATTLE_0::
	object_event  5, 24, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_OBJECT_EVENT_MONSTER_EVENT_ROUTE_30_BATTLE_0::
.ckir_BEFORE_OBJECT_EVENT_MONSTER_EVENT_ROUTE_30_BATTLE_1::
	object_event  5, 25, SPRITE_MONSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_OBJECT_EVENT_MONSTER_EVENT_ROUTE_30_BATTLE_1::
