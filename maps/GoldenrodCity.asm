...
.ckir_BEFORE_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_0:: ; bike shop
	object_event 28, 20, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket1Script, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_0::
	object_event  8, 15, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket2Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
        ;; the below Rockets can cause hardlocks if they're blocking
        ;; the player from obtaining a key item that they, for whatever
        ;; reason, skipped.
...
.ckir_BEFORE_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_1:: ; bike shop
	object_event 29, 20, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket4Script, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_1::
.ckir_BEFORE_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_2:: ; flower shop
	object_event 29,  7, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket5Script, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_object_event_EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER_ROCKET_2::
