...
.ckir_BEFORE_person_event_SPRITE_ROCKET_3:: ; bike shop
	person_event SPRITE_ROCKET, 20, 28, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, RocketScript_0x198a29, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_person_event_SPRITE_ROCKET_3::
...
.ckir_BEFORE_person_event_SPRITE_ROCKET_1:: ; bike shop
	person_event SPRITE_ROCKET, 20, 29, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, RocketScript_0x198a32, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_person_event_SPRITE_ROCKET_1::
.ckir_BEFORE_person_event_SPRITE_ROCKET_2:: ; flower shop
	person_event SPRITE_ROCKET, 7, 29, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, RocketScript_0x198a35, EVENT_GOT_A_POKEMON_FROM_ELM
.ckir_AFTER_person_event_SPRITE_ROCKET_2::
