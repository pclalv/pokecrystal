...
.ckir_BEFORE_OBJECT_EVENT_ULTRABALL:
	person_event SPRITE_POKE_BALL, 8, 13, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, UndergroundWarehouseUltraBall, EVENT_BLACKTHORN_CITY_SUPER_NERD_DOES_NOT_BLOCK_GYM
